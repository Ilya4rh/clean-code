...
Абзац начинающийся с "* " выделяется тегом \<li>, а все элементы маркерованного списка выделяются \<ul>
В тексте маркерованного списка могут присутствовать все прочие символы разметки с указанными правилами.
